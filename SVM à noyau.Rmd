...
for (c_val in C_values) {
  ...
  for (fold in 1:nfolds) {
    ...
    # Entraîner SVM avec noyau radial
    modele <- svm(DIFF ~ ., data = train_data, kernel = "radial", cost = c_val)
...
final_model <- svm(DIFF ~ ., data = data_subset, kernel = "radial", cost = best$C, probability = TRUE)
